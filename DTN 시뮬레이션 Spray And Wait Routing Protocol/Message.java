...
public class Message implements Comparable<Message> {
	...
	/** Base Spray And Wait: variable */
	public static final int INIT_COPIES = 10;
	private int copies;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		// Base Spray And Wait: initialize L copies
		this.copies = INIT_COPIES;
	}
	
	/** Base Spray And Wait: set L copies */
	public void setCopies(int l){
		this.copies = l;
	}
	
	/** Base Spray And Wait: get L copies */
	...
	protected void copyFrom(Message m) {
		...
		// Base Spray And Wait: L copies copy form
